...
try:
    ...
    from zg_storage_sdk.config import DEFAULT_CHUNK_SIZE, DEFAULT_SEGMENT_MAX_CHUNKS
    from zg_storage_sdk.utils.transfer import get_shard_configs, get_split_num
except ImportError:
    from zg_storage_sdk.core.storage_node import StorageNode
    from zg_storage_sdk.config import DEFAULT_CHUNK_SIZE, DEFAULT_SEGMENT_MAX_CHUNKS
    from zg_storage_sdk.utils.transfer import get_shard_configs, get_split_num
