...
try:
    from zg_storage_sdk.contracts.flow import FlowContract
    from zg_storage_sdk.core.storage_node import StorageNode
    from zg_storage_sdk.core.file import ZgFile
    from zg_storage_sdk.core.merkle import MerkleTree
    from zg_storage_sdk.config import (
        DEFAULT_CHUNK_SIZE,
        DEFAULT_SEGMENT_SIZE,
        DEFAULT_SEGMENT_MAX_CHUNKS
    )
    from zg_storage_sdk.utils.transfer import (
        get_shard_configs,
        calculate_price,
        delay,
        segment_range
    )
    from zg_storage_sdk.core.node_selector import check_replica
except ImportError:
    from zg_storage_sdk.contracts.flow import FlowContract
    from zg_storage_sdk.core.storage_node import StorageNode
    from zg_storage_sdk.core.file import ZgFile
...
class Uploader:
    ...
    def splitable_upload(
        ...
        """
        from zg_storage_sdk.utils.file_utils import next_pow2
        from zg_storage_sdk.config import DEFAULT_CHUNK_SIZE, DEFAULT_BATCH_SIZE
