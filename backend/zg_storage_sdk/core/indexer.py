...
try:
    from zg_storage_sdk.utils.http import HttpProvider
    from zg_storage_sdk.core.storage_node import StorageNode
    from zg_storage_sdk.core.node_selector import select_nodes
    from zg_storage_sdk.core.downloader import Downloader
    from zg_storage_sdk.core.uploader import Uploader
...
class Indexer(HttpProvider):
    ...
    def upload(
        ...
        # Ensure account is passed to uploader
        upload_opts['account'] = signer
